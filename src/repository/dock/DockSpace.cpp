...
namespace Metal {
    ...
    DockSpace DockSpace::CANVAS{5, "Scripting canvas", Icons::code, 4, 4, CB(CanvasPanel)};
    const char *DockSpace::OPTIONS = "Inspector\0Hierarchy\0Console\0Files\0Metrics\0Scripting";
